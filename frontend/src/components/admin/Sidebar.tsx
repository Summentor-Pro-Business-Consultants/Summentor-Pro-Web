...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ color: "#fff", fontWeight: 700, fontSize: 15.4, letterSpacing: "-0.01em" }}>
          Summentor Pro
        </div>
        {/* Subtle label below the product name to signal this is the admin area */}
        <div style={{ color: "#64748B", fontSize: 9.4, marginTop: 2, letterSpacing: "0.05em" }}>
          ADMIN PANEL
        </div>
      </div>
      ...
      <div style={{ padding: "16px 12px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div style={{ padding: "8px 12px", marginBottom: 4 }}>
          <div style={{ color: "#fff", fontSize: 11.2, fontWeight: 500 }}>
            {admin?.name ?? "Admin"}
          </div>
          <div style={{ color: "#64748B", fontSize: 9.4, marginTop: 1 }}>{admin?.email}</div>
        </div>
