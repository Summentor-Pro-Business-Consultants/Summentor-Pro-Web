...
export default function BlogPostPage() {
  ...
  if (notFound || !blog) {
    return (
      ...
      >
        <h1 style={{ fontFamily: "var(--sp-font-sans)", fontSize: 27.3, color: "#000" }}>
          Post not found
        </h1>
        <Link
          href="/blogs"
  ...
  return (
    <article>
      ...
      <style>{`
        .blog-content { font-family: var(--sp-font-sans); font-size: 14px; line-height: 1.65; color: var(--sp-navy-800, #1a2740); }
