  ...
  return (
    <article>
        ...
        <Container>
          ...
          <h1
            style={{
              ...
              fontSize: "clamp(24px, 3.42vw, 39px)",
              fontWeight: 700,
              color: "#fff",
              lineHeight: 1.1,
      ...
      <style>{`
        ...
        .legal-prose li::marker { color: var(--sp-green); }
        .legal-prose a { color: var(--sp-green); text-decoration: underline; text-underline-offset: 3px; text-decoration-color: var(--sp-green); }
